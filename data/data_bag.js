const data_bag = [
    ...
    {
        id: 1001, code: 'BR001', catalogId: 'bag',
    ...
    {
        id: 1002, code: 'BR002', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1003, code: 'BR003', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1004, code: 'BR004', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1005, code: 'BR005', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1006, code: 'BR006', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1007, code: 'BR007', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1008, code: 'BR008', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1009, code: 'BR009', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1011, code: 'BR011', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: true, inStock: true,
    ...
    {
        id: 1012, code: 'BR012', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: true, inStock: true,
    ...
    {
        id: 1013, code: 'BR013', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1014, code: 'BR014', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: true, inStock: true,
    ...
    {
        id: 1015, code: 'BR015', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1016, code: 'BR016', catalogId: 'bag',
        tags: { material: 'soi-co', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1017, code: 'BG001', catalogId: 'bag',
    ...
    {
        id: 1018, code: 'BG002', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1019, code: 'BG003', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1020, code: 'BG004', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
    ...
    {
        id: 1021, code: 'BG005', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
        name: { vi: 'Túi Hoa Khung Nguyệt', en: 'Túi Hoa Khung Nguyệt' },
        image: './Img/TuiXach/BG005/BG005_01.png',
        image1: './Img/TuiXach/BG005/BG005_02.png',
        image2: './Img/TuiXach/BG005/BG005_03.png',
        description: {
            vi: 'Kích thước: W20 x H18 x đáy 8cm\nMô tả chi tiết:\n- Chất liệu: sợi cỏ trắng\n- Quai xách: quai trúc tự nhiên\n- Miệng túi: nắp da sang trọng\n- Mặt trước: đính hoa nổi 3D tinh tế\n- Lót trong túi: vải canvas bền đẹp\nCâu chuyện sản phẩm: Quai trúc tự nhiên kết hợp sợi cỏ trắng đan thủ công tinh tế. Thiết kế nắp da sang trọng cùng hoa nổi 3D đính mặt trước tạo điểm nhấn nữ tính và thanh lịch. Bên trong lót vải canvas bền đẹp, phù hợp cho các buổi dạo phố, du lịch hoặc phối cùng trang phục mùa hè.',
            en: 'Size: W20 x H18 x D8 cm\nDetailed description:\n- Material: white grass fiber\n- Handle: natural bamboo handle\n- Opening: premium leather flap\n- Front: exquisite 3D floral embellishment\n- Inner lining: durable canvas fabric\nAI product description: Natural bamboo handles combined with beautifully hand-woven white grass fiber. Elegant leather flap design paired with 3D floral details on the front creates a feminine and sophisticated accent. Lined with durable canvas, it is perfect for strolling, travel, or matching summer outfits.'
        }
    },
    {
        id: 1022, code: 'BG006', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
        name: { vi: 'Túi Hoa Dã Viên', en: 'Túi Hoa Dã Viên' },
        ...
        description: {
            vi: 'Kích thước: W22 x H17 x đáy 8cm\nMô tả chi tiết:\n- Chất liệu: sợi cỏ\n- Quai xách: quai trúc tự nhiên\n- Mặt trước: đính hoa nổi 3D tinh tế\n- Lót trong túi: vải canvas chắc chắn\nCâu chuyện sản phẩm: Mẫu túi sợi cỏ quai trúc mang phong cách nhẹ nhàng, thanh lịch. Chi tiết hoa nổi 3D trên mặt trước tạo nét duyên dáng nổi bật, kết hợp lót canvas chắc chắn giúp bảo quản đồ dùng cá nhân gọn gàng và tiện lợi.',
            en: 'Size: W22 x H17 x D8 cm\nDetailed description:\n- Material: grass fiber\n- Handle: natural bamboo handle\n- Front: exquisite 3D floral embellishment\n- Inner lining: sturdy canvas fabric\nAI product description: Bamboo handle grass fiber bag exhibiting a gentle and elegant style. The 3D floral details on the front create a prominent graceful accent, paired with a sturdy canvas lining to keep personal items neatly organized and convenient.'
        }
    },
    {
        id: 1023, code: 'BG007', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
        name: { vi: 'Túi Hoa Mãn Viên', en: 'Túi Hoa Mãn Viên' },
        image: './Img/TuiXach/BG007/BG007_01.png',
        image1: './Img/TuiXach/BG007/BG007_02.png',
        image2: './Img/TuiXach/BG007/BG007_03.png',
        description: {
            vi: 'Kích thước: W20 x H18 x đáy 8cm\nMô tả chi tiết:\n- Chất liệu: sợi cỏ\n- Quai xách: quai trúc tự nhiên\n- Mặt trước: đính hoa nổi 3D tinh tế\n- Lót trong túi: vải canvas\nCâu chuyện sản phẩm: Thiết kế nhỏ gọn với chất liệu sợi cỏ tự nhiên và quai trúc độc đáo. Hoa nổi 3D được đính thủ công tinh tế, mang đến vẻ đẹp nữ tính, phù hợp cho những chuyến dạo phố hay nghỉ dưỡng.',
            en: 'Size: W20 x H18 x D8 cm\nDetailed description:\n- Material: grass fiber\n- Handle: natural bamboo handle\n- Front: exquisite 3D floral embellishment\n- Inner lining: canvas fabric\nAI product description: Compact design featuring natural grass fiber and unique bamboo handles. Handcrafted 3D floral details add a feminine touch, perfect for strolls or relaxing getaways.'
        }
    },
    {
        id: 1024, code: 'BG008', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
        name: { vi: 'Túi Hoa Kết Duyên', en: 'Túi Hoa Kết Duyên' },
        image: './Img/TuiXach/BG008/BG008_01.png',
        image1: './Img/TuiXach/BG008/BG008_02.png',
        image2: './Img/TuiXach/BG008/BG008_03.png',
        description: {
            vi: 'Kích thước: W20 x H18 và H22 (cao chỗ quai túi) x đáy 8cm\nMô tả chi tiết:\n- Chất liệu: sợi cỏ\n- Quai xách: quai trúc tự nhiên\n- Mặt trước: đính hoa nổi 3D tinh tế\n- Lót trong túi: vải canvas\nCâu chuyện sản phẩm: Túi sợi cỏ quai trúc được thiết kế hài hòa giữa nét mộc mạc và hiện đại. Điểm nhấn hoa nổi 3D giúp sản phẩm thêm nổi bật, trong khi lớp lót canvas bên trong mang lại sự tiện dụng cho nhu cầu sử dụng hằng ngày.',
            en: 'Size: W20 x H18/H22 (handle) x D8 cm\nDetailed description:\n- Material: grass fiber\n- Handle: natural bamboo handle\n- Front: exquisite 3D floral embellishment\n- Inner lining: canvas fabric\nAI product description: A bamboo handle grass fiber bag harmoniously blending rustic charm with modernity. The 3D floral accent makes it stand out, while the internal canvas lining provides utility for daily needs.'
        }
    },
    {
        id: 1025, code: 'BG009', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
        name: { vi: 'Túi Bách Hoa Viên', en: 'Túi Bách Hoa Viên' },
        image: './Img/TuiXach/BG009/BG009_01.png',
        image1: './Img/TuiXach/BG009/BG009_02.png',
        image2: './Img/TuiXach/BG009/BG009_03.png',
        description: {
            vi: 'Kích thước: W25 x H18 x đáy 10cm\nMô tả chi tiết:\n- Chất liệu: sợi cỏ\n- Quai xách: quai trúc tự nhiên\n- Mặt trước: đính hoa nổi 3D tinh tế\n- Lót trong túi: vải canvas\nCâu chuyện sản phẩm: Thiết kế rộng rãi với chất liệu sợi cỏ đan thủ công kết hợp quai trúc chắc chắn. Hoa nổi 3D trang trí mặt trước tạo vẻ đẹp tinh tế, phù hợp cho các chuyến du lịch, dã ngoại hoặc sử dụng hằng ngày.',
            en: 'Size: W25 x H18 x D10 cm\nDetailed description:\n- Material: grass fiber\n- Handle: natural bamboo handle\n- Front: exquisite 3D floral embellishment\n- Inner lining: canvas fabric\nAI product description: Spacious hand-woven grass fiber design with sturdy bamboo handles. The decorative 3D floral embellishment on the front adds a refined beauty, perfect for travel, picnics, or daily use.'
        }
    },
    {
        id: 1026, code: 'BG010', catalogId: 'bag',
        tags: { material: 'soi-co-grass', line: 'tui-xach' }, isNew: false, inStock: true,
